...
function loadConfig(){
	...
	if( fs.existsSync(root +"config/brisk.js") ){
...
function setupApp(){
	...
	var file = site.config.root +"config/express.js";
	if( !fs.existsSync(file) ) return;
	
	var config = require( site.config.root +"config/express")( site );
...
function findPath( dir ){
	...
	if( fs.existsSync(file) ){
		...
		var file = path.normalize( '../app/'+ dir ) +".js";
		if( fs.existsSync(file) ){
			return file;
		}
	}
